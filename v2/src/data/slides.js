  ...
  3: {
    ...
    slides: [
      ...
      },
      {
        ...
        content: {
          title: 'AWS Databases',
          subtitle: 'AWS Relational Database Service (RDS)',
          items: [
      ...
      },
      {
        ...
        content: {
          ...
          subtitle: 'Can store any sort of files up to a maximum size of 5 TB',
          description: 'Various storage classes help reduce overall costs:',
          items: [
            'General Purpose (Standard)',
            'Infrequent Access — millisecond retrieval, lower cost',
            'S3 Glacier Instant / Deep — Higher penalty for frequent access; deep can take up to 12 hours',
            'Object storage — pay as you go with options',
          ],
        },
      },
      {
        type: 'slide-content',
        note: 'EBS: block storage, attached to ONE EC2 instance at a time. Think of it as the hard drive for your EC2. Snapshots go to S3. gp3 is the default good choice.',
        content: {
          title: 'AWS Storage — Elastic Block Store',
          items: [
            'Scale Fast with high performance including replication within AZ',
            'Optimizable Cost depending on performance needed',
            'Allows encryption',
            'Allows backups as EBS snapshots — Snapshot storage also costs',
      ...
      {
        type: 'slide-content',
        note: 'EFS: shared file system, MULTIPLE instances at once. Like a network drive. More expensive than EBS but enables shared storage across instances — necessary for some architectures.',
        content: {
          title: 'AWS Storage — Elastic File System',
          items: [
            'File level not block level',
            'Unlimited scalability with automatic resizing as more storage is needed',
            'Optimizable Cost depending on performance needed — can scale higher than EBS',
